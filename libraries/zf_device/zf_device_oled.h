...
#define OLED_D0_PIN                     (SPI2_SCLK_P15_8 )                      // 硬件 SPI SCK 引脚
#define OLED_D1_PIN                     (SPI2_MOSI_P15_6)                       // 硬件 SPI MOSI 引脚
...
#define OLED_CS_PIN                     (P20_6 )                                // CS 片选引脚
...
extern const uint8 YuanShen[1024];
//===================================================定义 OLED 基本配置=================================================
